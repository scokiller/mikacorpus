'use strict';
(()=>{
  const ENDPOINT='https://xifxrkjvsrzexmuqtsvw.supabase.co/functions/v1/mikavideo-private/module?name=mikavideo-v04';
  async function boot(){
    try{
      ...
      (new Function(src))();
      try{log(`Mika Video privé chargé · v0.4 · r${r.headers.get('x-mikavideo-revision')||'?'} · SHA ✓`);}catch{}
