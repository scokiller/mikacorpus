'use strict';
(()=>{
  const ENDPOINT='https://xifxrkjvsrzexmuqtsvw.supabase.co/functions/v1/mikavideo-private/module?name=mikavideo-v03';
  async function boot(){
    try{
      ...
      (new Function(src))();
      try{log(`Mika Video privé chargé · v0.3 · r${r.headers.get('x-mikavideo-revision')||'?'} · SHA ✓`);}catch{}
